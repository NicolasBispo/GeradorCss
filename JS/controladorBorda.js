    ...
    if (todasBordasAtivo[0]) {
        ...
        if (todasBordasAtivo[1] == 'todos') {
            ...
            $('.cssExibido').append(
                `
                <div class='linha-css'>
                <span class="propriedade-css">border</span>:
                
                <p class="valores-css">` + todasBordasAtivo[2] + `</p>;
                <div>
                `
            );
            ...
            $.each(propsDirecao, function (index, valor) {
                ...
                if (valor !== "propVazia" && valor !== "") {
                    $('.cssExibido').append(
                        ...
                        `<div class='linha-css'>
                            <span class="propriedade-css">` + direcaoInserir + `</span>:
                            <p class="valores-css"> ` + valor + `</p>;
                        </div>`
    ...
    if (tipoBorderRadius[0]) {
        if (tipoBorderRadius[1] == "total") {
            $('.cssExibido').append(
                `
            <div class='linha-css'>
            <span class="propriedade-css">border-radius </span>:
            <p class="valores-css"> ` + tipoBorderRadius[2] + `</p>;
            </div>
            `
            )
        }
